...
- ✅ All paper citations verified against arxiv (tool-grounded, no hallucination)
- ✅ Grounding sources documented (NSF, course rubric, proposal-writing guides)
- ✅ Critique and scores transparent (student sees which standard each critique cites)
- ✅ Honest uncertainty admitted (agent says "I'm not sure" when appropriate)
- ✅ Human-in-the-loop: student decides what to accept/revise
- ✅ Reproducible: corpus sourced, code open, no proprietary data
